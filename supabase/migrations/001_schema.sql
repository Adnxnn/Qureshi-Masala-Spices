...
-- Helper function to get admin status of current user
...
(
  ...
  '[{"weight_grams": 100, "price": 89, "original_price": 99}]'::jsonb,
  50, 'chicken', '#C0392B',
...
(
  ...
  '[{"weight_grams": 100, "price": 99, "original_price": 119}]'::jsonb,
  50, 'chicken', '#E8730A',
